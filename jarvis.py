...
class Jarvis:
    def __init__(self) -> None:
        if platform == "linux" or platform == "linux2":
            ...
            self.chrome_path = p1 if os.path.exists(p1) else p2
        else:
...
if __name__ == '__main__':
    print("=" * 55)
    print("             JARVIS ASSISTANT ONLINE")
    print("  • Supports Voice Commands (via Mic)")
    print("  • Supports Typed Commands (via Console)")
    print("=" * 55)

    # Directly start JARVIS loop
    wakeUpJARVIS()
