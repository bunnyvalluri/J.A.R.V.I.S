...
(function () {
  ...
  function startPollingFallback() {
    if (!pollInterval) {
      ...
      pollInterval = setInterval(fetchTelemetryFallback, 3500);
    }
  }
  ...
  function initWebSocket() {
    // If not in browser environment or explicitly disabled
    ...
    try {
      ...
      state.ws.onclose = () => {
        ...
        state.reconnectTimer = setTimeout(initWebSocket, 6000);
      };
